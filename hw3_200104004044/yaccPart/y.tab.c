...
#line 41 "gpp_interpreter.y"
           { printf("%s\n", eval((yyvsp[0].node), table)); }
#line 1237 "y.tab.c"
    break;

  case 5: /* INPUT: FUNCTION  */
#line 42 "gpp_interpreter.y"
               { add_function_to_symbol_table(table, (yyvsp[0].function)); printf("#function\n"); }
#line 1243 "y.tab.c"
    break;
...
#line 48 "gpp_interpreter.y"
                                 { (yyval.node) = create_node_binary(NODE_ADD, (yyvsp[-2].node), (yyvsp[-1].node)); }
#line 1261 "y.tab.c"
    break;

  case 9: /* EXP: OP_OP OP_MINUS EXP EXP OP_CP  */
#line 49 "gpp_interpreter.y"
                                   { (yyval.node) = create_node_binary(NODE_SUBTRACT, (yyvsp[-2].node), (yyvsp[-1].node)); }
#line 1267 "y.tab.c"
    break;

  case 10: /* EXP: OP_OP OP_MULT EXP EXP OP_CP  */
#line 50 "gpp_interpreter.y"
                                  { (yyval.node) = create_node_binary(NODE_MULTIPLY, (yyvsp[-2].node), (yyvsp[-1].node)); }
#line 1273 "y.tab.c"
    break;

  case 11: /* EXP: OP_OP OP_DIV EXP EXP OP_CP  */
#line 51 "gpp_interpreter.y"
                                 { (yyval.node) = create_node_binary(NODE_DIVIDE, (yyvsp[-2].node), (yyvsp[-1].node)); }
#line 1279 "y.tab.c"
    break;

  case 12: /* EXP: OP_OP IDENTIFIER EXP OP_CP  */
#line 52 "gpp_interpreter.y"
                                 { (yyval.node) = create_node_function_call(create_node_identifier((yyvsp[-2].identifier)), (AstNode*[]){(yyvsp[-1].node)}, 1); }
#line 1285 "y.tab.c"
    break;

  case 13: /* EXP: OP_OP IDENTIFIER EXP EXP OP_CP  */
#line 53 "gpp_interpreter.y"
                                     { (yyval.node) = create_node_function_call(create_node_identifier((yyvsp[-3].identifier)), (AstNode*[]){(yyvsp[-2].node), (yyvsp[-1].node)}, 2); }
#line 1291 "y.tab.c"
    break;

  case 14: /* EXP: IDENTIFIER  */
#line 54 "gpp_interpreter.y"
                 { (yyval.node) = create_node_identifier((yyvsp[0].identifier)); }
#line 1297 "y.tab.c"
    break;

  case 15: /* EXP: VALUEF  */
#line 55 "gpp_interpreter.y"
             { (yyval.node) = create_node_constant((yyvsp[0].valuef)); }
#line 1303 "y.tab.c"
    break;

  case 16: /* FUNCTION: OP_OP KW_DEF IDENTIFIER EXP OP_CP  */
#line 59 "gpp_interpreter.y"
                                            { (yyval.function) = create_function(create_node_identifier((yyvsp[-2].identifier)), NULL, 0, (yyvsp[-1].node)); }
#line 1309 "y.tab.c"
    break;

  case 17: /* FUNCTION: OP_OP KW_DEF IDENTIFIER IDENTIFIER EXP OP_CP  */
#line 60 "gpp_interpreter.y"
                                                       { (yyval.function) = create_function(create_node_identifier((yyvsp[-3].identifier)), (AstNode*[]){create_node_identifier((yyvsp[-2].identifier))}, 1, (yyvsp[-1].node)); }
#line 1315 "y.tab.c"
    break;

  case 18: /* FUNCTION: OP_OP KW_DEF IDENTIFIER IDENTIFIER IDENTIFIER EXP OP_CP  */
#line 61 "gpp_interpreter.y"
                                                                  { (yyval.function) = create_function(create_node_identifier((yyvsp[-4].identifier)), (AstNode*[]){create_node_identifier((yyvsp[-3].identifier)), create_node_identifier((yyvsp[-2].identifier))}, 2, (yyvsp[-1].node)); }
#line 1321 "y.tab.c"
    break;
